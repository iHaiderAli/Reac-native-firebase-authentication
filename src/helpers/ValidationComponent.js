...
export default class ValidationComponent extends PureComponent {
  ...
  */
  ...
  _checkRules(fieldName, rules, value) {
    for (const key of Object.keys(rules)) {
      ...
      const isUnderfined = (value == undefined ? true : false);
      if ((isRuleFn && !this.rules[key](rules[key], value)) || (isRegExp && !this.rules[key].test(value)) || isUnderfined == true) {
